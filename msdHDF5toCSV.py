...
def main():
    outputFile1 = open('SongCSVWithTrackID.csv', 'w')
    csvRowString = ""
    ...
    #the user, 
        ...
        csvRowString = ("TrackID,AlbumID,AlbumName,ArtistID,ArtistLatitude,ArtistLocation,"+
            "ArtistLongitude,ArtistName,Danceability,Duration,KeySignature,"+
    ...
    for root, dirs, files in os.walk(basedir):        
        ...
        for f in files:
            ...
            song = Song(str(hdf5_getters.get_track_id(songH5File)))
